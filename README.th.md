...
/ (Root Project)
├── .ai/
│   ├── MEMORY.md                   # ความจำระยะยาวของโปรเจกต์ (Save Game)
│   ├── STATE.md                    # งานปัจจุบัน (RAM)
...
### การจัดการความจำ (Save/Load Game)
- **ตอนเริ่มต้น (Load Game):** ให้อ่านไฟล์ `.ai/MEMORY.md`, `.ai/STATE.md` และ `.ai/REFLECTIONS.md` ก่อน
- **ระหว่างทำ:** อัปเดต `.ai/STATE.md` เป็นระยะ
- **ตอนจบงาน (Save Game):** บันทึกสถานะล่าสุดลงใน `.ai/MEMORY.md` เพื่อไม่ให้ AI ลืมโปรเจกต์ในรอบหน้า
...
- **🌌 Futuristic**: แบบปัจจุบัน โทนมืด กระจกฝ้า อวกาศ (Default)
- **📊 Data Heavy**: สไตล์ Tremor เน้นตาราง ข้อมูล คลีนๆ
- **⚪ Minimal**: สไตล์ Vercel ขาว-ดำ เรียบง่าย คอนทราสต์สูง
- **🍭 Vibrant**: สไตล์ HeroUI สีสันสดใส ขอบมน มีชีวิตชีวา
...
# ติดตั้ง Git Hook (ป้องกันการลืมอัปเดต MEMORY.md และป้องกันไฟล์ .env หลุด)
